...
function _default(api, opts) {
  ...
  // 	false,
  // ],
  require.resolve("babel-plugin-macros"), [require.resolve("@babel/plugin-transform-destructuring"), {
  ...
  // ...
  require.resolve("@babel/plugin-syntax-dynamic-import"), require.resolve("@babel/plugin-proposal-async-generator-functions"), // 目前开启 allowDeclareFields 后，和以下三个插件有冲突，先禁用
  // [
